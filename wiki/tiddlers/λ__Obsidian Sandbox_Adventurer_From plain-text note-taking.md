Obsidian is similar to plain-text based note-taking apps in the sense that [[a vault is just a local folder|λ:/Obsidian Sandbox/Vault is just a local folder]].
